...
".label RESULT_HI    = $13\n"
"\n"
".label MATH_MUL_A_LO = $D770   // multiplicand A low byte\n"
".label MATH_MUL_A_HI = $D771   // multiplicand A high byte (clear for 8-bit)\n"
".label MATH_MUL_B_LO = $D772   // multiplicand B low byte\n"
".label MATH_MUL_B_HI = $D773   // multiplicand B high byte (clear for 8-bit)\n"
".label MATH_RESULT_0 = $D778   // result byte 0 (LSB)\n"
".label MATH_RESULT_1 = $D779   // result byte 1\n"
"\n"
"mul8_mega65:\n"
"    lda #0\n"
